export const members: {
    ...
    },
    {
        ...
        links: [
            ...
            {
                icon: "email",
                url: "mailto:huijie.wang@opendrivelab.com",
            },
            {
                icon: "github",
                url: "https://github.com/faikit",
            },
            {
                icon: "x",
    ...
    },
    {
        ...
        links: [
            ...
            {
                icon: "email",
                url: "mailto:litianyu@opendrivelab.com",
            },
            {
                icon: "github",
                url: "https://github.com/sephyli",
            },
            {
                icon: "x",
    ...
    },
    {
        ...
        links: [
            ...
            {
                icon: "email",
                url: "mailto:snow@opendrivelab.com",
            },
            {
                icon: "github",
    ...
    },
    {
        ...
        links: [
            {
                icon: "homepage",
                url: "https://zhouyunsong.github.io/",
            },
            {
                icon: "scholar",
            ...
            {
                icon: "email",
                url: "mailto:zhouyunsong@opendrivelab.com",
            },
            {
                icon: "github",
    ...
    },
    {
        ...
        links: [
            {
                icon: "scholar",
                url: "https://scholar.google.com/citations?user=DoyuNwEAAAAJ",
            },
            {
                icon: "email",
                url: "mailto:tianhaochen2023@ia.ac.cn",
            },
            {
                icon: "github",
    ...
    },
    {
        ...
        links: [
            {
                icon: "email",
                url: "mailto:cj65000816081@gmail.com",
            },
            {
                icon: "scholar",
                url: "https://scholar.google.com/citations?user=4FqHXOsAAAAJ",
            },
            {
                icon: "github",
    ...
    },
    {
        ...
        links: [
            ...
            {
                icon: "email",
                url: "mailto:xiechengen@opendrivelab.com",
            },
            {
                icon: "github",
    ...
    },
    {
        ...
        links: [
            ...
            {
                icon: "email",
                url: "mailto:serene.js.cai@gmail.com",
            },
            {
                icon: "github",
    ...
    },
    {
        ...
        links: [
            ...
            {
                icon: "scholar",
                url: "https://scholar.google.com/citations?user=I6bAD78AAAAJ",
            },
            {
                icon: "email",
                url: "mailto:shamdan17@ku.edu.tr",
            },
            {
                icon: "github",

...
import TextTip, { Footnote } from "./textTip"
            ...
            <div className="max-w-7xl mx-auto flex flex-col">
                    ...
                    <div className="flex flex-col w-full gap-6 px-6 max-w-7xl">
                        ...
                        <div className="flex flex-col gap-2 font-mono">
                            ...
                            <div className="flex flex-row gap-6 md:gap-10 xl:gap-20 2xl:gap-40">
                                <h2 className="whitespace-nowrap shrink-0 w-[6rem]">Published</h2>
                                <h2 className="flex-1 break-words">December 24, 2025</h2>
                            </div>
                            {/* Report */}
                            <div className="flex flex-row gap-6 md:gap-10 xl:gap-20 2xl:gap-40">
                                <h2 className="whitespace-nowrap shrink-0 w-[6rem]">Report</h2>
                                <h2 className="flex-1 break-words">Available in Late January 2026</h2>
                            </div>
                            {/* Email */}
                            <div className="flex flex-row gap-6 md:gap-10 xl:gap-20 2xl:gap-40">
                                <h2 className="whitespace-nowrap shrink-0 w-[6rem]">Email</h2>
                                <h2 className="flex-1 break-all">
                                    <Link className="text-o-blue animated-underline hover:text-o-blue" href="mailto:research@mmlab.hk">
                                        research@mmlab.hk
                                    </Link>
                                </h2>
                            </div>
                            {/* By */}
                            <div className="flex flex-row gap-6 md:gap-10 xl:gap-20 2xl:gap-40">
                                <h2 className="whitespace-nowrap shrink-0 w-[6rem]">By</h2>
                                <h2 className="flex-1">HKU MMLab</h2>
                            </div>
                            {/* Post */}
                            <div className="flex flex-row gap-6 md:gap-10 xl:gap-20 2xl:gap-40">
                                <h2 className="whitespace-nowrap shrink-0 w-[6rem]">Share</h2>
                                <h2 className="flex-1 flex flex-row flex-wrap gap-x-2 items-center">
                                    <Link className="text-o-blue animated-underline hover:text-o-blue" href="https://x.com/OpenDriveLab/status/2003745616955142150?s=20" target="_blank">X</Link>
                                    <span className="text-xs select-none">|</span>
                                    <Link className="text-o-blue animated-underline hover:text-o-blue" href="https://www.linkedin.com/feed/update/urn:li:activity:7409531902761795584/" target="_blank">LinkedIn</Link>
                                    <span className="text-xs select-none">|</span>
                                    <Link className="text-o-blue animated-underline hover:text-o-blue" href="https://bsky.app/profile/opendrivelab.bsky.social/post/3mapyr5u4nc24" target="_blank">Bluesky</Link>
                                </h2>
                            </div>
                        </div>
                    </div>
                ...
                <div className="w-full flex flex-col items-center my-20 px-6" id="introduction" >
                    <div className="w-full flex flex-col items-center">
                        <div className="w-full max-w-4xl flex flex-col relative p-10 gap-6">
                            ...
                            <h2 className="text-4xl font-bold text-center">Veni, vidi, vici.</h2>
                        </div>
                    </div>
                ...
                <TextTip offset={0}>
                    <p className="w-full leading-relaxed">
                        ...
                        Pi0
                        <Footnote id={1} link="https://www.physicalintelligence.company/blog/pi0">
                            &pi;<sub>0</sub> (2024)
                        </Footnote>{" "}
                        and{" "}
                        GO-1
                        <Footnote id={2} link="https://opendrivelab.com/OpenGO1/">
                            GO-1 (2025)
                        </Footnote>{" "}
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <ol className="space-y-3 w-full leading-relaxed list-[lower-alpha] px-6">
                            <li>
                                <i>Mode Consistency:&nbsp;</i>
                                We argue that not all data is equally valuable. By strictly aligning the human demonstration distribution (<span className="font-math">P<sub>train</sub></span>), the model's knowledge (<span className="font-math">Q<sub>model</sub></span>), and the test-time distribution (<span className="font-math">P<sub>test</sub></span>), we minimize in-distribution shifts that lead to failure.
                            </li>
                            <li>
                                <i>Model Arithmetic:&nbsp;</i>
                ...
                <div className="w-full flex flex-col items-center px-6">
                    <div className="w-full max-w-4xl mt-20 text-4xl font-bold">
                ...
                <div className="w-full flex flex-col items-center px-6">
                    <div className="w-full max-w-4xl mt-10 text-xl font-bold">
                        <Link href="#mode_consistency" className="scroll-mt-32 group flex items-center flex-row" id="mode_consistency">
                            <h2>Mode Consistency: Addressing the Distributional Trilemma</h2>
                            <div className="min-w-12 select-none">
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <ol className="space-y-3 w-full leading-relaxed list-[lower-alpha] px-6">
                            <li>
                                <span className="font-math">P<sub>train</sub></span> (Human Demonstrations): The empirical distribution collected from the human expert policy, <span className="font-math">Q<sub>human</sub></span>. This represents a limited subset of the valid solution manifold <span className="font-math">P<sub>real</sub></span>.
                            </li>
                            <li>
                                <span className="font-math">Q<sub>model</sub></span> (Learned Policy): The policy distribution parameterized by the model weights.
                            </li>
                            <li>
                                <span className="font-math">P<sub>test</sub></span> (Real-World Execution): The actual distribution of actions executed during physical deployment, inferred from <span className="font-math">Q<sub>model</sub></span>. Success is defined by the intersection of <span className="font-math">P<sub>test</sub></span> and <span className="font-math">P<sub>real</sub></span>, while the portion of <span className="font-math">P<sub>test</sub></span> falling outside <span className="font-math">P<sub>real</sub></span> constitutes the failure modes.
                            </li>
                        </ol>
                    </TextTip>
                </div>
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <p className="w-full leading-relaxed max-w-4xl">
                            Standard imitation learning paradigms generally aim to minimize the divergence <span className="font-math">KL(Q<sub>model</sub>|Q<sub>human</sub>)</span> over the support of <span className="font-math">P<sub>train</sub></span>
                            <Footnote id={3} link="https://arxiv.org/abs/2510.18874">
                                Retaining by Doing (Chen et al., 2025)
                            </Footnote>
                            <Footnote id={4} link="https://arxiv.org/abs/2404.14367">
                                Preference Fine-Tuning (Tajwar et al., 2024)
                            </Footnote>.
                            This process yields a finetuned <span className="font-math">Q<sub>model</sub></span>, deploying this model via an inference function (denoted as <span className="font-math">Inference</span>) results in the realized distribution <span className="font-math">P<sub>test</sub></span>.
                        </p>
                    </TextTip>
                </div>
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <ol className="space-y-3 w-full leading-relaxed max-w-4xl list-[lower-alpha] px-6">
                            <li>
                                Distribution Shift between <span className="font-math">P<sub>train</sub></span> and <span className="font-math">P<sub>test</sub></span>: Interpreted as covariate shift, where the model encounters states during deployment that were absent in the training data.
                            </li>
                            <li>
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <ol className="space-y-3 w-full leading-relaxed max-w-4xl list-[lower-alpha] px-6">
                            <li>
                                <b>Data Scope:</b>
                                <ol className="space-y-3 w-full leading-relaxed max-w-4xl list-disc px-6 mt-3">
                                    <li>
                                        <i>DAgger (Iterative Correction):&nbsp;</i>
                                        Static offline demonstrations often lack exposure to failure modes that inevitably emerge during real-world deployment
                                        <Footnote id={5} link="https://arxiv.org/abs/1011.0686">
                                            DAgger (Ross et al., 2011)
                                        </Footnote>
                                        <Footnote id={6} link="https://arxiv.org/abs/1810.02890">
                                            HG-DAgger (Kelly et al., 2018)
                                        </Footnote>
                                        <Footnote id={7} link="https://arxiv.org/abs/2509.07953">
                                            RaC (Hu et al., 2025)
                                        </Footnote>.
                                        We inject on-policy recovery trajectories - utilizing both heuristic methods and iterative DAgger - to populate these sparse regions. These "corrected" trajectories expand <span className="font-math">P<sub>train</sub></span> towards underrepresented but critical regions of <span className="font-math">P<sub>real</sub></span>.
                                    </li>
                                    <li>
                                        <i>Spatio-Temporal Augmentation:&nbsp;</i>
                                        To further bridge the gap between <span className="font-math">P<sub>train</sub></span> and <span className="font-math">P<sub>test</sub></span>, we employ structured augmentations across space and time. Spatially, we utilize mirroring and symmetry to enhance the model's understanding of dual-arm coordination. Temporally, time-scaling introduces variability in trajectory speed, allowing the model to adapt to fluctuating control frequencies.
                                    </li>
                                </ol>
                            </li>
                        </ol>
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <ol className="space-y-3 w-full leading-relaxed max-w-4xl list-[lower-alpha] px-6"  start={2}>
                            <li>
                                <b>Inference Scope:&nbsp;</b>
                                To optimize the translation of <span className="font-math">Q<sub>model</sub></span> into <span className="font-math">P<sub>test</sub></span> via the <span className="font-math">Inference</span> function, we utilize Chunk-wise Temporal Smoothing coupled with Real-time Chunking.
                                <Footnote id={8} link="https://arxiv.org/abs/2506.07339">
                                    Real-Time Action Chunking (Black et al., 2025)
                                </Footnote>
                                This effectively minimizes execution jitter and ensures the policy's intended actions are translated flawlessly into smooth, coherent real-robot execution. And we found that such smoothness contributes much to the final performance, i.e., success rate.
                            </li>
                        </ol>
                    </TextTip>
                </div>
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <p className="w-full leading-relaxed">
                            To visualize how our methods achieve progressive consistency among <span className="font-math">P<sub>train</sub></span>, <span className="font-math">Q<sub>model</sub></span>, and <span className="font-math">P<sub>test</sub></span>, we project their action distributions on TaskA into a 3D t-SNE space.
                        </p>
                    </TextTip>
                </div>
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <p className="w-full leading-relaxed max-w-4xl">
                            We propose <i>Model Arithmetic (MA)</i>: train only on newly collected data subsets, then merge the resulting model with previous ones through <i>weight interpolation
                            <Footnote id={9} link="https://proceedings.mlr.press/v162/wortsman22a.html">
                                Model Soups (Wortsman et al., 2021)
                            </Footnote>
                            guided by on-policy optimization</i>. Remarkably, this synthesis can even <i>surpass the performance of models trained on the entire dataset at once</i>.
                        </p>
                    </TextTip>
                </div>
                ...
                <div className="mt-6">
                    <TextTip offset={0}>
                        <p className="w-full leading-relaxed max-w-4xl">
                            ...
                            <Footnote id={10} link="https://openreview.net/forum?id=Seb7rprW1Y">
                ...
                <TextTip offset={0}>
                <div className="mt-6">
                        <ol className="space-y-3 w-full leading-relaxed list-[lower-alpha] px-6 text-muted-foreground">
                            <li>
                                <span className="text-foreground font-medium">Not all robot data is equally valuable.</span> The quality and characteristics of training data significantly impact policy performance.
                            </li>
                            <li>

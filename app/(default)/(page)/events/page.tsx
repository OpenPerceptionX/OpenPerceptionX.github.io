                    ...
                    <Timeline>
                        <TimelineItem>
                            ...
                            <TimelineContent className="flex flex-col gap-3">
                                ...
                                <TimelineDescription className="text-sm">
                                    <Link href="/legacy/challenge2025/index.html#1x-wm" className="text-o-blue animated-underline">
                                        [Challenge] World Model Challenge by 1X
                                    </Link>
                                </TimelineDescription>
                                <TimelineDescription className="text-sm">
                                    <Link href="/legacy/challenge2025/index.html#navsim-e2e-driving" className="text-o-blue animated-underline">
                        ...
                        <TimelineItem>
                            ...
                            <TimelineContent className="flex flex-col gap-3">
                                ...
                                <TimelineDescription className="text-sm">
                                    <Link href="/legacy/challenge2025/index.html#agibot-world" className="text-o-blue animated-underline">
